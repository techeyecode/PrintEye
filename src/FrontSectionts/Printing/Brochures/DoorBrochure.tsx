...
import { doorBrochures } from "./BrochuresIteams"; // make sure the file name matches
import BrochureCard from "./BrochureCard";

const DoorBrochure: React.FC = () => {
  return (
